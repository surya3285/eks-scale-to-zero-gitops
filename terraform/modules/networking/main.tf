...
locals {
  ...
  # Only the first AZ gets a NAT gateway when single_nat_gateway = true; every
  # private route table then points at that one gateway.
...
resource "aws_vpc_endpoint" "interface" {
  for_each = var.enable_interface_endpoints ? toset(["ecr.api", "ecr.dkr", "sts"]) : []
